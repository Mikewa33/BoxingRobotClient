...
export default class UiButtonForStore extends Phaser.GameObjects.Container {
  constructor(scene, x, y, key, hoverKey, text, targetCallback, scale=1.4, nftWallet, callbackParam) {
    super(scene, x, y);
  ...
  createButton(scale) {
    ...
    this.button.on('pointerdown', () => {
      this.targetCallback(this.scene, this.nftWallet, this.callbackParam);
    });
